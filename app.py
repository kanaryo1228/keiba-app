...
<head>
    ...
    <title>地方競馬 AI予想ダッシュボード PRO</title>
...
def get_default_nar_data():
    return pd.DataFrame([
        {"waku": "1", "umaban": 1, "horse_name": "ミックファイア", "jockey": "御神本", "burden_weight": 57.0, "odds": 3.2, "horse_weight_text": "495(+2)", "paddock_sign": "仕上がり良好", "paddock_score": 1.0, "running_style": "先行", "base_speed_idx": 86.5, "past_summary": "前走: 1着 (重賞GP)"},
        {"waku": "2", "umaban": 2, "horse_name": "ヒーローコール", "jockey": "森泰斗", "burden_weight": 57.0, "odds": 4.5, "horse_weight_text": "482(0)", "paddock_sign": "仕上がり良好", "paddock_score": 1.0, "running_style": "逃げ/先行", "base_speed_idx": 85.0, "past_summary": "前走: 2着 (戸塚記念)"},
        {"waku": "3", "umaban": 3, "horse_name": "マンダリンヒーロー", "jockey": "矢野貴", "burden_weight": 57.0, "odds": 8.8, "horse_weight_text": "478(-2)", "paddock_sign": "仕上がり良好", "paddock_score": 1.0, "running_style": "差し", "base_speed_idx": 84.0, "past_summary": "前走: 3着 (黒潮盃)"},
        {"waku": "4", "umaban": 4, "horse_name": "ライトウォーリア", "jockey": "吉原寛", "burden_weight": 57.0, "odds": 14.2, "horse_weight_text": "504(+14)", "paddock_sign": "太め注意", "paddock_score": -2.0, "running_style": "逃げ/先行", "base_speed_idx": 82.5, "past_summary": "前走: 1着 (埼玉新聞栄冠)"},
        {"waku": "5", "umaban": 5, "horse_name": "ギガキング", "jockey": "和田譲", "burden_weight": 57.0, "odds": 22.0, "horse_weight_text": "490(+4)", "paddock_sign": "良好", "paddock_score": 0.5, "running_style": "差し", "base_speed_idx": 82.0, "past_summary": "前走: 4着 (報知グランプリ)"},
        {"waku": "6", "umaban": 6, "horse_name": "カジノフォンテン", "jockey": "本田重", "burden_weight": 57.0, "odds": 38.5, "horse_weight_text": "512(-12)", "paddock_sign": "大幅減", "paddock_score": -2.2, "running_style": "先行", "base_speed_idx": 78.0, "past_summary": "前走: 6着 (勝島王冠)"},
        {"waku": "7", "umaban": 7, "horse_name": "セイカメテオポリス", "jockey": "笹川翼", "burden_weight": 57.0, "odds": 18.0, "horse_weight_text": "488(+2)", "paddock_sign": "仕上がり良好", "paddock_score": 1.0, "running_style": "追込", "base_speed_idx": 83.5, "past_summary": "前走: 2着 (東京記念)"},
        {"waku": "8", "umaban": 8, "horse_name": "スワーヴアラミス", "jockey": "町田直", "burden_weight": 57.0, "odds": 52.0, "horse_weight_text": "496(+1)", "paddock_sign": "良好", "paddock_score": 0.0, "running_style": "差し", "base_speed_idx": 77.0, "past_summary": "前走: 8着 (ゴールドC)"},
...
def build_view(df: pd.DataFrame, race_name: str, venue_info: str, race_id_str: str = "", strategy: str = "balanced", current_url: str = ""):
    ...
    if strategy == "safe":
        ...
        bet_primary_sub = "本日バイアス合致の実力最上位軸"
        ...
        bet_primary_sub = "当日トラックバイアス合算の真の本命"
    ...
    for _, row in df.sort_values(by="umaban").iterrows():
        ...
        if row["bonus_tags"]:
            for t in row["bonus_tags"].split():
                color = "bg-rose-50 text-rose-700 border-rose-200" if "減" in t or "注" in t or "割" in t else "bg-emerald-50 text-emerald-700 border-emerald-200"
    ...
    return HTML_CONTENT.format(
        ...
        pace_analysis_comment="当日の内外伸び所と直前パドックの仕上がりをリアルタイム反映中",
